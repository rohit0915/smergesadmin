    ...
    return (
        <>
            <div className="content_padding">
                ...
                <div className="mb-3 page_heading">Manage Press Category</div>
                            ...
                            {!addMangeopen ? (
                                <div>
                                    <span className="mt-1 ml-2 addmanageuserfont hover_cursor" onClick={() => setaddMangeopen(!addMangeopen)}>
                                        <i className="fa fa-plus-circle mr-1"></i> <strong> Add New Press Category </strong>
                                    </span>
                                </div>
                            ) : (
                                                ...
                                                <div className="card_content_instition">
                                                    ...
                                                    <div className="mr-2 mt-1">
                                                        <input
                                                            ...
                                                            placeholder="Enter Press Category"
                                                            autoComplete="off"
                                                        />
                                                    </div>
...
export default HOC(PressCategory)
