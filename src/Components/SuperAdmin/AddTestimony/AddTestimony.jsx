    ...
    return (
        <>
            <div className="content_padding">
                ...
                <div className="mb-3 page_heading">Manage Testimony Data</div>
                            ...
                            {!addMangeopen ? (
                                <div>
                                    <span className="mt-1 ml-2 addmanageuserfont hover_cursor" onClick={() => setaddMangeopen(!addMangeopen)}>
                                        <i className="fa fa-plus-circle mr-1"></i> <strong> Add New Testimony </strong>
                                    </span>
                                </div>
                            ) : (
...
export default HOC(AddTestimony)
